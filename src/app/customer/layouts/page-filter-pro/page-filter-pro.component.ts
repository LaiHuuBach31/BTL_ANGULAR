...
@Component({
  selector: 'app-page-filter-pro',
  templateUrl: './page-filter-pro.component.html',
  styleUrls: ['./page-filter-pro.component.css']
})
export class PageFilterProComponent implements OnInit {
